...
img = cv2.imread("D:\Kuliah\judul-skripsi\codingan\objecy-measurement-master\input\gelapbgt.jpg")
...
#image crop
  #image = cv2.imread(r"D:\Kuliah\judul-skripsi\codingan\Object-measurement-python-openCV-masterr\input\cth.jpg")
    y=200
    x=500
    h=800
    w=250
